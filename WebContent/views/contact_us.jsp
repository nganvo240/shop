    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
	    				<h2 class="title text-center">Điền vào đây</h2>
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
				            ...
				            <div class="form-group col-md-12">
				                <input type="submit" name="submit" class="btn btn-primary pull-right" value="Gửi" onclick="myFunction()">
				            </div>
				        </form>
	    			</div>
	    		</div>
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<div class="social-networks">
							...
							<ul>
								<li>
									<a href="https://www.facebook.com/groups/utehcmc"><i class="fa fa-facebook"></i></a>
								</li>
							</ul>
	    				</div>
	    			</div>
